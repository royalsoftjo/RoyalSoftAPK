...
public class frm_OutgoingVoucher extends AppCompatActivity {
    ListView listView;
    Adapter_OutgoingVoucher Adapter;
    ArrayList<Cls_Virable_OutgoingVoucher> alist;
    private RequestQueue mQueue;
    TextView textdate;
    //-------------------------------------------------
    Spinner spinnerEmp,spinnerStaionID;
    String IDUser,NameUser,IDStaion,IDID,dateWork;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm__outgoing_voucher);

        listView =findViewById(R.id.list_OutgoingVoucher);
        ...
        bt_Search_USER.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getdata(Integer.valueOf(IDID),dateWork,Integer.valueOf(IDUser));
            }
        });

//-------------------------------Spinner-----------------------------------------------------
        spinnerEmp=(Spinner)findViewById(R.id.Spinner_Name_Emp);
        spinnerStaionID=(Spinner) findViewById(R.id.spinner_StaionID);
...
//----------------------------------Cls_User_Spinner--------------------------------------------------------------------------------------------------------------------------
        ...
        mQueue = Volley.newRequestQueue(frm_OutgoingVoucher.this);
...
//--------------------------------------------------------------------------------------------------------------//
        ...
        textdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog=new DatePickerDialog(frm_OutgoingVoucher.this,android.R.style.Theme_Holo_Light_Dialog_MinWidth,mDateSetListener,year,Month,Day);
    ...
    private void getdata(int StationID,String WorkDayDate,int CreationUserID) {
        ...
        conRoyal.UrlRoyal_OutgoingVoucher(conRoyal.ConnectionString,StationID,WorkDayDate,CreationUserID);
        mQueue = Volley.newRequestQueue(this);

        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET,conRoyal.Url_OutgoingVoucher, null,
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                Cls_Virable_OutgoingVoucher a=new Cls_Virable_OutgoingVoucher();
                            ...
                            Adapter = new Adapter_OutgoingVoucher(frm_OutgoingVoucher.this, alist);
    ...
    {
         IDUser = user.getIDUserNameEmp();
         NameUser = user.getUserNameEmp();
    ...
    {
         IDStaion = StaionID.getStaionID();
         IDID = StaionID.getIDStaionID();

        Toast.makeText(this,IDStaion,Toast.LENGTH_SHORT).show();
    }
